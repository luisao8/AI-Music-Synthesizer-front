...
function Footer() {
  ...
  return (
    <footer className="fixed inset-x-0 bottom-0 py-10 sm:pt-16 lg:pt-7 w-full" style={{ backgroundColor: '#FAFAFA' }}>
    <div class="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
        <div class="grid grid-cols-2 md:col-span-3 lg:grid-cols-6 gap-y-16 gap-x-12">
            <div class="col-span-2 md:col-span-3 lg:col-span-2 lg:pr-8">
                <img src={logo} style={{ height: '40x', width: "120px", borderRadius: "8px" }}/>

                <p class="text-base leading-relaxed text-gray-600 mt-3">Discover other AI track creations and share your with the community.</p>
            ...
            <div>
                ...
                <ul class="mt-6 space-y-4">
                    ...
                    <li>
                        <a href="#" title="" class="flex text-base text-black transition-all duration-200 hover:text-blue-600 focus:text-blue-600"> Careers </a>
                    </li>
                </ul>
            </div>
            ...
            <div class="col-span-2 md:col-span-1 lg:col-span-2 lg:pl-8">
                <p class="text-sm font-semibold tracking-widest text-gray-400 uppercase">Subscribe for news on AI in music:</p>
